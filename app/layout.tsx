    ...
    <html lang="en">
      ...
      <body>
        ...
        <Box className="w-screen h-screen flex items-center overflow-hidden">
          <Box className={`${pathname === "/sign-in" ? "hidden" : "w-[340px] h-[75%] h-screen"} `}>
            <Sidebar />
          </Box>
          <Box className={`${pathname === "/sign-in" ? "w-screen h-screen" : "w-[90%] h-screen bg-[#F8F8F8] flex justify-center items-center"}`}>
            <Box className={`${pathname === "/sign-in" ? "w-screen h-screen" : "h-[95%] w-[95%] bg-[#fff]"}`}>
              {children}
            </Box>
          </Box>
        </Box>
