...
export const useGetDashboardJustifications = ({ startDate = null, endDate = null }: any) => {

    const [loading, setLoading] = useState<boolean>(false);
    const [error, setError] = useState<string | null>(null);
    const [data, setData] = useState<any>(null);

    const getDashboardJustifications = async () => {
        setError(null);
        setLoading(true);
        ...
        try {
            ...
            const url = `/dashboard/justifications?${params.toString()}`;
