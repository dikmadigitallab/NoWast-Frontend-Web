...
export default function ADM_Dikma() {
    return (
        <Box className="w-full flex flex-wrap flex-row justify-around">
            <Box className="flex flex-col items-center justify-between gap-2 md:w-[100%] lg:w-[28%] p-4 rounded-sm h-[400px] border-1 border-[#5e58731f]">
                ...
                <span className='text-[#5E5873] text-[.8rem] text-center'>lLorem Ipsum is simply dummy text of the printing and typesetting industry.</span>
