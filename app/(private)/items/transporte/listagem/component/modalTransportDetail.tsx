            ...
            <Box className="absolute top-0 right-0 w-[600px] h-full bg-white z-10 overflow-y-auto z-2">
                <Box className="px-5">
                    ...
                    <Box className="flex justify-between items-center h-[45px] border-b border-[#E0E0E0]">
                        <h2 className="text-[#6E6B7B] text-[1.2rem] font-semibold">Detalhes do Transporte </h2>
                    ...
                    <Box className="mt-3 flex flex-col gap-3">
                        <Box className="w-full h-[300px] rounded-2xl overflow-hidden">
                            <img src={modalDetail?.transportFiles[0]?.file.url} alt={modalDetail?.name} className="w-full h-full object-contain object-top" />
                        </Box>
