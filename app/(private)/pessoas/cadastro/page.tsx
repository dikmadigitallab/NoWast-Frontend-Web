...
import { z } from "zod";
import { TextField, MenuItem, Checkbox, ListItemText, InputLabel, Select, FormControl, Button, Chip, OutlinedInput, Box, FormHelperText, Modal } from "@mui/material";
        ...
        <StyledMainContainer>
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
                ...
                <Box className="w-[100%] flex flex-row gap-5 justify-end">
                    ...
                    <Button type="submit" variant="outlined" sx={[buttonTheme, { alignSelf: "end" }]}>Cadastrar</Button>
                </Box>
            </form>
